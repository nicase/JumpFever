class Player{
    ...
    constructor(id) {
        ...
        this.walls = [new Walls(this.lx, this.ty, this.rx, this.ty), new Walls(this.rx, this.ty, this.rx, this.by),
            new Walls(this.rx, this.by, this.lx, this.by), new Walls(this.lx, this.by, this.lx, this.ty)]
    }
